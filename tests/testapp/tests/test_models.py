...
class DatabaseMaxCounterUpdateCalculationTestCase(TestCase):
    def setUp(self):
        self.filter = "filter"
...
class TransferSessionDeletionTestCase(TestCase):
    def setUp(self):
...
class SyncSessionDeletionTestCase(TestCase):
    def setUp(self):
        self.syncsession = SyncSession.objects.create(
            id=uuid.uuid4().hex,
            profile="facilitydata",
    ...
    def test_model_soft_deletion(self):
        ...
        self.assertTrue(Buffer.objects.count() > 0)
        self.assertTrue(RecordMaxCounterBuffer.objects.count() > 0)
        self.syncsession.delete(soft=True)
        self.assertEqual(SyncSession.objects.count(), 1)
        self.assertEqual(TransferSession.objects.count(), 1)
        self.assertTrue(Buffer.objects.count() == 0)
        self.assertTrue(RecordMaxCounterBuffer.objects.count() == 0)
    ...
    def test_model_hard_deletion(self):
        ...
        self.assertTrue(RecordMaxCounterBuffer.objects.count() > 0)
        self.assertEqual(SyncSession.objects.count(), 1)
        self.syncsession.delete(soft=False)
    ...
    def test_queryset_soft_deletion(self):
        ...
        self.assertTrue(RecordMaxCounterBuffer.objects.count() > 0)
        self.assertEqual(SyncSession.objects.count(), 1)
        SyncSession.objects.delete(soft=True)
        self.assertEqual(SyncSession.objects.count(), 1)
        self.assertEqual(TransferSession.objects.count(), 1)
        self.assertTrue(Buffer.objects.count() == 0)
        self.assertTrue(RecordMaxCounterBuffer.objects.count() == 0)
    ...
    def test_queryset_hard_deletion(self):
        ...
        self.assertTrue(RecordMaxCounterBuffer.objects.count() > 0)
        self.assertEqual(SyncSession.objects.count(), 1)
        SyncSession.objects.delete(soft=False)
        self.assertEqual(SyncSession.objects.count(), 0)
        self.assertEqual(TransferSession.objects.count(), 0)
        self.assertTrue(Buffer.objects.count() == 0)
        self.assertTrue(RecordMaxCounterBuffer.objects.count() == 0)
